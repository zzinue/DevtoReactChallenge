...
function RightSidebar() {
    return (
        <aside className='RightBar'>
            <div className='RightBar-Card-Hackathon'>
                <p> <img src="https://picsum.photos/200/300" alt="" /></p>
                <h2><a href="">Hack the Planet "with New Relic & Dev</a></h2>
                <p>Use New Relic to build a climate-change observability app for the chance to win up to $5,000!
                    <strong><a href="">&nbsp;Join the Hackathon</a></strong>
                </p>
            </div>
